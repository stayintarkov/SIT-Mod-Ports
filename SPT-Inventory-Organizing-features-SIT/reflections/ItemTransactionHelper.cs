...
namespace InventoryOrganizingFeatures.Reflections
{
    ...
    internal static class ItemTransactionHelper
    {
        ...
        public static object Move(Item item, ItemAddress to, InventoryController itemController, bool simulate = false)
        {
        ...
        // Usually simulate = true
        public static object TransferOrMerge(Item item, Item targetItem, InventoryController itemController, bool simulate)
        {
