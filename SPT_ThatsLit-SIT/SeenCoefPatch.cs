...
namespace ThatsLit
{
    public class SeenCoefPatch : ModulePatch
    {
        ...
        protected override MethodBase GetTargetMethod()
        {
            ...
            return ReflectionHelper.FindMethodByArgTypes(enemyInfoType, new Type[] { typeof(BifacialTransform), typeof(BifacialTransform), typeof(GClass504), typeof(AIData), typeof(float), typeof(Vector3) }); ;
        }
