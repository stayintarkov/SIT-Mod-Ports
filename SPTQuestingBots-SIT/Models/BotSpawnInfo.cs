...
namespace SPTQuestingBots.Models
{
    ...
    {
        public Data1 Data { get; private set; }
        ...
        public BotSpawnInfo(Data1 data, BotGenerator botGenerator)
        {
            Data = data;
            BotGenerator = botGenerator;
        }

        public BotSpawnInfo(Data1 data, BotGenerator botGenerator, Configuration.MinMaxConfig raidETRangeToSpawn) : this(data, botGenerator)
        {
        ...
        public void SeparateBotOwner(BotOwner bot)
        {
            ...
            Data1 newData = Data1.CreateWithoutProfile(bot.SpawnProfileData);
