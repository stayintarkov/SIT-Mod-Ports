...
namespace SPTQuestingBots.Patches
{
    public class LoadBotsPatch : ModulePatch
    {
        ...
        private static void PatchPrefix(List<WaveInfo> conditions)
        {
            ...
            {
                raidTimeRemainingFraction = StayInTarkov.AkiSupport.Singleplayer.Utils.InRaid.RaidTimeUtil.GetRaidTimeRemainingFraction();
            }
            else
            {
                raidTimeRemainingFraction = (float)StayInTarkov.AkiSupport.Singleplayer.Utils.InRaid.RaidChangesUtil.NewEscapeTimeMinutes / StayInTarkov.AkiSupport.Singleplayer.Utils.InRaid.RaidChangesUtil.OriginalEscapeTimeMinutes;
            }
