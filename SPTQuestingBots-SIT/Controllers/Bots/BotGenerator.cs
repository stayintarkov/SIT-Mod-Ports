...
namespace SPTQuestingBots.Controllers.Bots
{
    public class BotGenerator : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // float raidTimeRemainingFraction = Math.Min(GClass1476.EscapeTimeSeconds(Singleton<AbstractGame>.Instance.GameTimer), 
            ...
            float timeSinceSpawning = GClass1476.PastTimeSeconds(Singleton<AbstractGame>.Instance.GameTimer);
            ...
            try
            {
                ...
                while (botsGenerated < totalCount)
                {
                    ...
                    try
                    {
                        ...
                        Data1 botSpawnData = await Data1.Create(botProfileData, ibotCreator, botsInGroup, botSpawnerClass);
