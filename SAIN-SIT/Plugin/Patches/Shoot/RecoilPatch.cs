...
namespace SAIN.Patches.Shoot
{
    public class AimOffsetPatch : ModulePatch
    {
        ...
        [PatchPrefix]
        public static bool PatchPrefix(ref GClass491 __instance, ref BotOwner ___botOwner_0, ref Vector3 ___vector3_5, ref Vector3 ___vector3_4, ref float ___float_13)
        {
